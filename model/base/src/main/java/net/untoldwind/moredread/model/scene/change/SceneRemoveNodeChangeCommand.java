...
public class SceneRemoveNodeChangeCommand extends AbstractOperation implements
		ISceneChangeCommand {
	...
	public SceneRemoveNodeChangeCommand(
			final AbstractSpatialComposite<?> parent, final INode child) {
		super("Delete node " + child.getName());
	...
	public String getStageId() {
		return "Remove_" + parentNodeId + "_" + childNodeId;
	}
