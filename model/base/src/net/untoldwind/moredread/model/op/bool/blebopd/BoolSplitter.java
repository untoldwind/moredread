...
public class BoolSplitter {
	 ...
	 */
	static Vector3d splitEdge(final Plane3d plane, final BoolFace f, final int e) {
		BoolVertex v1, v2;
		...
		return MathUtils.intersectPlane3d(plane, p1, p2);
	}
	 ...
	 */
	static BoolSegment splitFace(final Plane3d plane, final BoolFace f) {
		...
		final int tag1 = BoolTag.createTAG(MathUtils.classify(v1.getPoint3d(),
				plane));
		final int tag2 = BoolTag.createTAG(MathUtils.classify(v2.getPoint3d(),
				plane));
		final int tag3 = BoolTag.createTAG(MathUtils.classify(v3.getPoint3d(),
				plane));
